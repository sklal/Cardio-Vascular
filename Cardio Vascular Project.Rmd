...
# fixing height - assuming the height of the population in females is not less than 150 cm(approx. 4 feet 11 inches) and not less than 155 cm(5 ft 1 inches) in males . Replacing the value below these parameters by their respective medians 
...
cd$height<-ifelse(gender==1 & cd$height<150,femaleheightm, ifelse(gender==2 & cd$height<155,maleheightm,cd$height) )
...
cd$weight<-ifelse(gender==1 & cd$weight<45,femaleweightm, ifelse(gender==1 & cd$weight>120,femaleweightm,ifelse(gender==2 & cd$weight<55,maleweightm,ifelse(gender==2 & cd$weight>120,maleweightm,cd$weight))))
